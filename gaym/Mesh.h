...
{
public:
	GridPlaneMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList,
	              float fWidth = 1.0f, float fDepth = 1.0f, int nGridX = 64, int nGridZ = 64);
	virtual ~GridPlaneMesh();
