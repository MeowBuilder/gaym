...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Player::_internal_playerid() const {
  return playerid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Player::playerid() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.playerId)
  return _internal_playerid();
}
inline void Player::_internal_set_playerid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  playerid_ = value;
}
inline void Player::set_playerid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
