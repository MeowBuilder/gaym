...
Player::_table_ = {
  {
    ...
    // uint64 playerId = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(Player, _impl_.playerid_), 1>(),
     {8, 1, 0,
    ...
    // uint64 playerId = 1;
    {PROTOBUF_FIELD_OFFSET(Player, _impl_.playerid_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
    // string name = 2;
